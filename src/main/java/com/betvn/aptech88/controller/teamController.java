...
//create leauge
	...
	// find team by id
	@RequestMapping(value= "/GetTeamById", method = RequestMethod.POST, consumes= ("application/json"))
	public team findTeamByID (@RequestBody team tea)
	{
		team t = teams.findById(tea.getId());
		return t;
	}	
